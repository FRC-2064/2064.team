...
[Enter Stage 1A Workbench :material-share-variant:](https://cad.onshape.com/classes/69ef9246c70581c5f4ff7cbd/assignment/69ef931a9b2068bc9afc4c2b)
...
- <span style="color: var(--md-primary-fg-color);">:material-cog:</span> **Part 1: Studio Fundamentals & Setup**
    ...
    <br>[Go to Section 1: Setup :material-open-in-new:](https://www.frcdesign.org/learning-course/stage1/1A/section1-setup/)
...
- <span style="color: var(--md-primary-fg-color);">:material-layers:</span> **Part 2: Designing Plates**
    ...
    <br>[Go to Section 2: Plates :material-open-in-new:](https://www.frcdesign.org/learning-course/stage1/1A/section2-exercise1/)
...
- <span style="color: var(--md-primary-fg-color);">:material-link-variant:</span> **Part 3: Assemblies & Mates**
    ...
    <br>[Go to Section 3: Assemblies :material-open-in-new:](https://www.frcdesign.org/learning-course/stage1/1A/section3-exercise1/)
