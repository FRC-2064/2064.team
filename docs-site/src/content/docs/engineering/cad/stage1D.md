...
- [x] **1.2.4 - Stage 1C (Practice Mechanisms)**
- [x] **1.3.4 - Safety Practical**
- [x] **1.4.14 - Skill Check - Level 02**
- [x] **1.5.5 - Skill Check - Drive Challenge**
- [x] **1.5.10 - Launcher Competition**
...
[Enter Stage 1D Workbench :material-truck-fast-outline:](https://cad.onshape.com/classes/69ef9246c70581c5f4ff7cbd/assignment/69efb4132cc81a32f19fa461)
...
* **Part 1: The Theory** Read these to understand the "Master Sketch" philosophy.
    * [Read: Top Down Design :material-open-in-new:](https://www.frcdesign.org/learning-course/stage1/1D/top-down-design/)
    * [Read: Project Overview :material-open-in-new:](https://www.frcdesign.org/learning-course/stage1/1D/project-overview/)
...
* **Part 2: The Drivebase Project** Follow the tutorials to model the chassis tubes and assemble the base inside your Step 1 document.
    * [Go to Step 1: Layout Sketch :material-open-in-new:](https://www.frcdesign.org/learning-course/stage1/1D/layout-sketch/)
    * [Go to Step 2: Part Studio :material-open-in-new:](https://www.frcdesign.org/learning-course/stage1/1D/part-studio/)
    * [Go to Step 3: Assembly :material-open-in-new:](https://www.frcdesign.org/learning-course/stage1/1D/assembly/)

* **Part 3: Final Integration** Add the bellypan, bumpers, and the scoring mechanism to your drivebase.
    * [Go to Step 4: Adding Components :material-open-in-new:](https://www.frcdesign.org/learning-course/stage1/1D/adding-components/)
    * [Go to Step 5: Top Level Assembly :material-open-in-new:](https://www.frcdesign.org/learning-course/stage1/1D/top-level-assembly/)
