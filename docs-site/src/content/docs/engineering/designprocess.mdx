...
* **8. Refine and Optimize**
  ...
  * **Bumpers:** Should have the frame perimeter decided and may begin constructing bumpers for this year's robot.
...
* **10. Communicate and Document**
  * **Documentation:** Create comprehensive documentation (like this site!) for judges and sponsors.
