---
title: "1.1.6 - Power On"
---

> Examining last season's robot, let's review how we connect to a robot and turn it on - Every year this process will mostly be the same - even though the robot is different.
