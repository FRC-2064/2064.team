...
* **[1.1.2 - Bot Basics](/frc/botbasics/):** Common parts of an FRC robot.
* **[1.1.3 - Game Analysis](/frc/gameanalysis/):** Analyze a past game and pass a quiz on the game content.
* **[1.1.4 - Engineering Design Process](/engineering/designprocess/):** Brainstorming, prototyping, and documenting decisions.
...
* **[1.2.1 - Stage 0 (New to CAD)](/engineering/cad/stage0/):** General information on CAD and Onshape setup.
* **[1.2.2 - Stage 1A (Fundamentals)](/engineering/cad/stage1A/):** Sketching, extruding, and multi-part studios.
...
* **[1.3.1 - General Safety](/safety/Safety/):** Core shop rules, PPE, and emergency procedures.
* **[1.3.2 - Machine Safety](/safety/machinesafety/):** Specific safety rules for general machines.
...
* **Level 1: General Shop (Unpowered)**
    * **[1.4.1 - Workspace Organization](/fabrication/level1/Closet/):** Closet management and battery care.
    * **[1.4.2 - Fasteners](/fabrication/level1/fasteners/):** Learn about the hardware used on the robot.
    * **[1.4.3.1 - Measuring Devices](/fabrication/level1/measuring/measuringtools/):** Calipers and tape measures.
    * **[1.4.4 - Wrenches](/fabrication/level1/handtools/Handtools/):** Wrenches and allen wrenches.
    * **[1.4.5 - Pliers](/fabrication/level1/handtools/pliers/):** Pliers and other tools.
    * **[1.4.6 - Wiring & Crimping](/fabrication/level1/handtools/crimping/):** Secure electrical connections.
    * **[1.4.7 - 3D Printer](/fabrication/level1/3dprinter/):** Exporting STEP files and basic 3D Printing.
    * **[1.4.8 - Skill Check - Level 01](/fabrication/level1/handtoolsquiz/):** Show your understanding of Level 1 skills.
* **Level 2: Power Tools**
    * **[1.4.9 - Cordless Drill](/fabrication/level2/poweredhandtools/poweredtools/):** Cordless drill explanation.
    * **[1.4.10 - Cordless Saw](/fabrication/level2/poweredhandtools/cordlesssaw/):** Overview of the cordless bandsaw.
    * **[1.4.11 - Soldering Iron](/fabrication/level2/powertools/soldering/):** Permanent FRC electrical connections.
...
* **XRP Start:**
    * **[1.5.1 - Build Guide](/xrprobotics/module1/Build/):** Chassis assembly.
    * **[1.5.2 - XRP Firmware Installation](/xrprobotics/module1/gettingtoknow/):** Connection and firmware setup.
    * **[1.5.3 - VSCode and WPIlib](/xrprobotics/module1/xrpwpilib/):** Setting up the FRC programming environment.
    * **[1.5.4 - Command-Based Code](/xrprobotics/module1/basicdriveXRP/):** Writing Java to drive the XRP.
    * **[1.5.5 - Skill Check - Drive Challenge](/xrprobotics/module1/XRPdrivechallenge/):** Driving and autonomous skill check.
* **XRP Advanced:**
    * **[1.5.6 - Launcher Game Concepts](/xrprobotics/module2/Ping-Pong-Launcher-Challenge/):** Advanced small-scale game simulation.
    * **[1.5.7 - Ping Pong Assembly](/xrprobotics/module2/PingPongAssemble/):** Steps to create ping pong bot.
...
* **Level 3 Overview:**
    * **[2.2.1 - 3D Printing Workflow](/fabrication/level3/3dprinting2/):** Slicing, filaments, and SLA.
    * **[2.2.2 - Horizontal Bandsaw](/fabrication/level3/bandsaw/):** Manual contour cutting.
    * **[2.2.3 - Lathe Operations](/fabrication/level3/lathe/):** Turning shafts and cutting grooves.
    * **[2.2.4 - Milling Machine Basics](/fabrication/level3/millingmachine/):** Squaring stock and edge finding.
    * **[2.2.5 - Skill Check - Level 3](/fabrication/level3/machinelessons/):** Level 3 Skill Check.
* **Level 4 Overview:**
    * **[2.2.6 - Laser Engraver Workflow](/fabrication/level4/laserengraver/):** Vector cutting and etching.
...
* **[2.3.3 - Sensor Integration](/engineering/programming/sensors/):** Reading encoders, gyros, and limit switches.
* **[2.3.4 - Autonomous Routines](/engineering/programming/autonomous/):** Path planning and trajectory following.
...
* **[2.4.1 - Branding Guideline](/media/branding/):** Official fonts, hex codes, and uniform guidelines.
* **[2.4.2 - Adobe Photoshop](/media/photoshop/):** Photo editing and social media asset creation.
* **[2.4.3 - Adobe Illustrator](/media/illustrator/):** Vector design for banners and apparel.
...
* **[3.1.2 - Scouting Architecture](/strategy/scouting/):** Designing digital scouting apps to collect data.
...
* **[3.2.2 - Triage & Troubleshooting](/competition/triage/):** The 8-minute turnaround between matches.
* **[3.2.3 - The Inspection Process](/competition/inspection/):** Navigating sizing, weight, and hardware checks.
...
* **[3.3.2 - Awards](/leadership/awards/):** FRC awards and season alignment.
...
* **Team Resources:** [View Core Values & Glossary](/resources/resourceslanding/)
