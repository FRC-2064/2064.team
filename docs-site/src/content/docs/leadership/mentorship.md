---
title: "3.3.5 - The Art of Mentorship"
---
...
1. The "Safety First" Leadership Framework
Leadership in a machine shop carries a unique responsibility. Student leaders are the first line of defense for team safety.
...
2. Managing Work: The Agile/Scrum Approach
To help students manage themselves without constant mentor oversight, we use a simplified Agile workflow. This removes the "What do I do now?" bottleneck.

The Kanban Method
Maintain a board (physical or digital) with four columns:
...
The 5-Minute "Stand-Up"
At the start of every session, the student lead facilitates a 5-minute meeting:
* What did we finish last time?
* What are we doing today?
* What is "blocking" us? (This is where mentors step in to help).

3. The Mentor Connection: "Ask 3, Then Me"
To foster autonomy while staying connected to mentor expertise, use the **Ask 3, Then Me** protocol:
1.  **Ask yourself:** Did I check the technical documentation or CAD?
2.  **Ask a peer:** Does someone else in my sub-team know?
3.  **Ask a lead:** Does the student lead have the answer?
4.  **Ask a mentor:** If the previous three fail, engage a mentor for high-level guidance.
...
4. Conflict Resolution & Soft Skills
Leadership is 10% technical and 90% people.
...
A leader's job is to ensure the team's knowledge survives after they graduate.
