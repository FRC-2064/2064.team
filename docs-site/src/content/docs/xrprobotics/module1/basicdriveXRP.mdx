...
<LinkButton 
  href="https://github.com/FRC-2064/XRP-Cammand-Based-Introduction" 
  variant="secondary" 
  target="_blank" 
...
<LinkButton 
  href="https://drive.google.com/drive/folders/1wv03eLxbPXerzkzLPjl76Cc5_cHNRrug?usp=sharing" 
  variant="secondary" 
  target="_blank" 
  rel="noopener noreferrer"
  class="repo-btn"
  icon="github"
>
  View Source Code on Google Drive
</LinkButton>
