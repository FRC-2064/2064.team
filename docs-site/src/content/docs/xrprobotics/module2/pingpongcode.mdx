...
If your network restricts Github page from opening or code copying, a backup copy of this sketch is also available via the class Google Drive folder linked in your student portal.
