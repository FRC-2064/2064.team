...
<LinkButton 
  ...
  class="repo-btn"
>
  View The Github XRP Code Repository 
</LinkButton>

<LinkButton 
  href="https://drive.google.com/drive/folders/1w9-1suqC-vzwHK8dVjqrriwjWCZYRe9M?usp=drive_link" 
  variant="secondary" 
  target="_blank" 
  rel="noopener noreferrer"
  class="repo-btn"
>
  View The Google Drive for Code Folder
</LinkButton>
:::
